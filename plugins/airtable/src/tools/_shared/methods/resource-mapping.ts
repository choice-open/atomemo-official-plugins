...
const withSingleStringInputNote = (
  en_US: string,
  zh_Hans: string,
): LocalizedText =>
  localized(
    `${en_US} When entering a single string in the textbox, do not include double quotes.`,
    `${zh_Hans}（当在文本框中输入单个字符串时，不需要输入双引号）`,
  )
...
const FIELD_VALUE_HINTS: Record<string, LocalizedText> = {
  barcode: withSingleStringInputNote(
  ...
  checkbox: withSingleStringInputNote(
  ...
  currency: withSingleStringInputNote(
  ...
  email: withSingleStringInputNote(
    'Email string. Example: "name@example.com".',
    '邮箱字符串。例如："name@example.com"。',
  ),
  multilineText: withSingleStringInputNote(
    'String cell value. Example: "Line 1\\nLine 2".',
    '字符串类型的单元格值。例如："第 1 行\\n第 2 行"。',
  ),
  multipleAttachments: withSingleStringInputNote(
  ...
  multipleCollaborators: withSingleStringInputNote(
  ...
  multipleRecordLinks: withSingleStringInputNote(
  ...
  multipleSelects: withSingleStringInputNote(
  ...
  number: withSingleStringInputNote(
    'Accepts a number or numeric string; values are normalized to a number. Example: 123.45 or "123.45".',
    '接受数字或数字字符串；值会被规范化为数字。例如：123.45 或 "123.45"。',
  ),
  percent: withSingleStringInputNote(
  ...
  singleLineText: withSingleStringInputNote(
    'String cell value. Example: "Example text".',
    '字符串类型的单元格值。例如："示例文本"。',
  ),
  singleSelect: withSingleStringInputNote(
