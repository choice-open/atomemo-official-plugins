...
export const unlikeTweetTool = {
  name: "twitter-unlike-tweet",
  display_name: t("TWITTER_TOOL_UNLIKE_TWEET_DISPLAY_NAME"),
  description: t("TWITTER_TOOL_UNLIKE_TWEET_DESCRIPTION"),
  icon: "💔",
  skill: getSkill("unlike-tweet"),
  ...
  async invoke({ args }) {
    ...
    const res = await client.users.unlikePost(userId, args.parameters.tweet_id)
