...
export const undoRetweetTool = {
  name: "twitter-undo-retweet",
  display_name: t("TWITTER_TOOL_UNDO_RETWEET_DISPLAY_NAME"),
  description: t("TWITTER_TOOL_UNDO_RETWEET_DESCRIPTION"),
  icon: "🔁",
  skill: getSkill("undo-retweet"),
  ...
  async invoke({ args }) {
    ...
    const res = await client.users.unrepostPost(
      userId,
      args.parameters.tweet_id,
    )
