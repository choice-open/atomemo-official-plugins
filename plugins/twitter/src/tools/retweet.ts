...
export const retweetTool = {
  name: "twitter-retweet",
  display_name: t("TWITTER_TOOL_RETWEET_DISPLAY_NAME"),
  description: t("TWITTER_TOOL_RETWEET_DESCRIPTION"),
  icon: "🔁",
  skill: getSkill("retweet"),
  ...
  async invoke({ args }) {
    ...
    const res = await client.users.repostPost(userId, {
