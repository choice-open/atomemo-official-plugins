...
import supabaseAuthAdminOauthUpdateClientSkill from "./supabase-auth-admin-oauth-update-client-skill.md" with { type: "text" }
...
export const supabaseAuthAdminOAuthUpdateClientTool: ToolDefinition = {
  ...
  skill: supabaseAuthAdminOauthUpdateClientSkill,
  icon: "✏️",
  parameters: [
    {
