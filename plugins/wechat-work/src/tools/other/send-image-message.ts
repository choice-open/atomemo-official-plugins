...
export const sendImageMessageTool: ToolDefinition = {
  name: "wechat-work-send-image",
  display_name: {
    en_US: "Send image message",
    zh_Hans: "发送图片消息",
  },
  description: {
    en_US: "Send an image message to members via a self-built application.",
    zh_Hans: "通过自建应用向成员发送图片消息。",
  },
  ...
  parameters: [
    ...
    },
    {
      ...
      ui: {
        component: "input",
        hint: {
          en_US: "Media ID from material upload API",
          zh_Hans: "通过素材上传接口获取的 media_id",
        },
        support_expression: true,
        width: "full",
      },
