...
import sendVoiceMessageSkill from "./send-voice-message-skill.md" with {
  type: "text",
}
...
export const sendVoiceMessageTool: ToolDefinition = {
  name: "wechat-work-send-voice",
  display_name: {
    en_US: "Send voice message",
    zh_Hans: "发送语音消息",
  },
  description: {
    en_US: "Send a voice message to members via a self-built application.",
    zh_Hans: "通过自建应用向成员发送语音消息。",
  },
  skill: sendVoiceMessageSkill,
  icon: "🎤",
  parameters: [
    {
