...
const getMeetingInfoBodySchema = z.object({
  meetingid: z.string().describe("会议ID"),
});
...
export const getMeetingInfoTool: ToolDefinition = {
  ...
  description: {
    en_US: "Get details of a specified meeting via POST /meeting/get_info.",
