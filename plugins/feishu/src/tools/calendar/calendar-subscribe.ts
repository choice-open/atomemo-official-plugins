...
import calendar_subscribeSkill from "./calendar-subscribe-skill.md" with { type: "text" }
...
export const feishuCalendarSubscribeTool: ToolDefinition = {
  name: `feishu-${fn.id}`,
  display_name: {
