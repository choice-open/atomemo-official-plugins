...
import calendar_unsubscribeSkill from "./calendar-unsubscribe-skill.md" with { type: "text" }

const fn: FeishuApiFunction = {
  id: "calendar_unsubscribe",
  legacy_id: "f053",
  module: "calendar",
  name: "取消订阅日历",
  method: "POST",
...
export const feishuCalendarUnsubscribeTool: ToolDefinition = {
  name: `feishu-${fn.id}`,
  display_name: {
  ...
  skill: calendar_unsubscribeSkill,
  icon: "🪶",
  parameters: [
    {
      name: "credential_id",
