...
import calendar_create_timeoffSkill from "./calendar-create-timeoff-skill.md" with { type: "text" }

const fn: FeishuApiFunction = {
  id: "calendar_create_timeoff",
  legacy_id: "f057",
  module: "calendar",
  name: "创建请假日程",
  method: "POST",
...
export const feishuCalendarCreateTimeoffTool: ToolDefinition = {
  name: `feishu-${fn.id}`,
  display_name: {
  ...
  skill: calendar_create_timeoffSkill,
  icon: "🪶",
  parameters: [
    {
      name: "credential_id",
