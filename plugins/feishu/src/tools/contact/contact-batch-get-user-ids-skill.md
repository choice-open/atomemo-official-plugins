# 通过手机号或邮箱获取用户ID Tool Documentation

## Tool

- **Name**: `feishu-contact_batch_get_user_ids`
- **Module**: `contact`
- **Method**: `POST`
- **Path**: `/open-apis/contact/v3/users/batch_get_id`
- **Purpose**: Calls Feishu Open API endpoint `POST /open-apis/contact/v3/users/batch_get_id`.
