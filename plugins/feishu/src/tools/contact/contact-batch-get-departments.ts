...
import contact_batch_get_departmentsSkill from "./contact-batch-get-departments-skill.md" with { type: "text" }

const fn: FeishuApiFunction = {
  id: "contact_batch_get_departments",
  legacy_id: "f010",
  module: "contact",
  name: "批量获取部门信息",
  method: "POST",
  path: "/open-apis/contact/v3/departments/batch_get",
};

export const feishuContactBatchGetDepartmentsTool: ToolDefinition = {
  name: `feishu-${fn.id}`,
  display_name: {
  ...
  skill: contact_batch_get_departmentsSkill,
  icon: "🪶",
  parameters: [
    {
      name: "credential_id",
