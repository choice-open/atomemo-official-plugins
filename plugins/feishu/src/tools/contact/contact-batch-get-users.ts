...
import contact_batch_get_usersSkill from "./contact-batch-get-users-skill.md" with { type: "text" }

const fn: FeishuApiFunction = {
  id: "contact_batch_get_users",
  legacy_id: "f004",
  module: "contact",
  name: "批量获取员工信息",
  method: "POST",
  path: "/open-apis/contact/v3/users/batch_get",
};

export const feishuContactBatchGetUsersTool: ToolDefinition = {
  name: `feishu-${fn.id}`,
  display_name: {
  ...
  skill: contact_batch_get_usersSkill,
  icon: "🪶",
  parameters: [
    {
      name: "credential_id",
