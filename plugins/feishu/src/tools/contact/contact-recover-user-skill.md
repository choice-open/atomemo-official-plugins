# 恢复已删除用户 Tool Documentation

## Tool

- **Name**: `feishu-contact_recover_user`
- **Module**: `contact`
- **Method**: `POST`
- **Path**: `/open-apis/contact/v3/users/:user_id/recover`
- **Purpose**: Calls Feishu Open API endpoint `POST /open-apis/contact/v3/users/:user_id/recover`.
