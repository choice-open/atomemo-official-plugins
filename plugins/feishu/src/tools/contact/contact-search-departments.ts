...
import contact_search_departmentsSkill from "./contact-search-departments-skill.md" with { type: "text" }

const fn: FeishuApiFunction = {
  id: "contact_search_departments",
  legacy_id: "f012",
  module: "contact",
  name: "搜索部门",
  method: "POST",
...
export const feishuContactSearchDepartmentsTool: ToolDefinition = {
  name: `feishu-${fn.id}`,
  display_name: {
  ...
  skill: contact_search_departmentsSkill,
  icon: "🪶",
  parameters: [
    {
      name: "credential_id",
