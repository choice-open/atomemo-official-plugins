...
export const googleDocsOAuth2Credential = {
  name: "google-docs-oauth2",
  display_name: t("GOOGLE_DOCS_CREDENTIAL_DISPLAY_NAME"),
  description: t("GOOGLE_DOCS_CREDENTIAL_DESCRIPTION"),
  icon: "📄",
  oauth2: true,
  parameters: [
    {
...
export type GoogleDocsCredential = {
  access_token: string
  refresh_token?: string
  expires_at?: number
  client_id: string
