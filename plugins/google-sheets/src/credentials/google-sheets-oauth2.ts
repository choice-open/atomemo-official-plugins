...
export const GOOGLE_SHEETS_OAUTH2_CREDENTIAL_NAME = "Google_Sheets_OAuth2"

export const googleSheetsOAuth2Credential = {
  name: GOOGLE_SHEETS_OAUTH2_CREDENTIAL_NAME,
  ...
  oauth2_build_authorize_url: async ({ args }) => {
    ...
    return { url: `${AUTHORIZATION_ENDPOINT}?${params.toString()}` }
  },
  ...
  oauth2_get_token: async ({ args }) => {
    ...
    return { parameters_patch: parametersPatch }
  },
