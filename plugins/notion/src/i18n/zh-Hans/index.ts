...
const zh_Hans = {
  ...
  SORT_TIMESTAMP_DISPLAY_NAME: "时间戳",
  ...
  SEARCH_DATABASES_FILTER_LLM_DESCRIPTION:
    "过滤器固定为仅返回数据库（数据源）。",
  SEARCH_DATABASES_FILTER_DISPLAY_NAME: "过滤条件",
  ...
  CREATE_PAGE_IN_DATABASE_PARENT_ID_LLM_DESCRIPTION:
    "将创建新页面的父数据源（数据库） ID。",
  CREATE_PAGE_IN_DATABASE_PARENT_DISPLAY_NAME: "父级",
  ...
  CREATE_PAGE_PARENT_DISPLAY_NAME: "父级",
  ...
  // Blocks - Heading
  BLOCKS_HEADING_IS_TOGGLEABLE_DISPLAY_NAME: "可折叠",
  BLOCKS_HEADING_IS_TOGGLEABLE_HINT: "标题是否可以切换以显示/隐藏嵌套内容",
  BLOCKS_URL_DISPLAY_NAME: "链接",
  BLOCKS_URL_HINT: "要嵌入或链接到的外部资源的 URL",
  BLOCKS_COLOR_DISPLAY_NAME: "颜色",
  BLOCKS_EXTERNAL_URL_DISPLAY_NAME: "外部链接",

  // Blocks - Rich Text
  BLOCKS_RICH_TEXT_DISPLAY_NAME: "富文本",
  BLOCKS_TITLE_DISPLAY_NAME: "标题",
  BLOCKS_ANNOTATIONS_DISPLAY_NAME: "注释",
  BLOCKS_ANNOTATION_BOLD_DISPLAY_NAME: "加粗",
  BLOCKS_ANNOTATION_ITALIC_DISPLAY_NAME: "斜体",
  BLOCKS_ANNOTATION_STRIKETHROUGH_DISPLAY_NAME: "删除线",
  BLOCKS_ANNOTATION_UNDERLINE_DISPLAY_NAME: "下划线",
  BLOCKS_ANNOTATION_CODE_DISPLAY_NAME: "代码",
  ID_DISPLAY_NAME: "ID",
  NAME_DISPLAY_NAME: "名称",
  DESCRIPTION_DISPLAY_NAME: "描述",
  COLOR_DISPLAY_NAME: "颜色",

  // Blocks - Select Option
  BLOCKS_SELECT_OPTION_DISPLAY_NAME: "选项",
  PROPERTY_ID_OR_NAME_DISPLAY_NAME: "属性 ID 或 名称",
  ...
  BLOCKS_CHECKED_DISPLAY_NAME: "已勾选",
  BLOCKS_ICON_DISPLAY_NAME: "图标",
  BLOCKS_TYPE_DISPLAY_NAME: "类型",
  BLOCKS_EXPRESSION_DISPLAY_NAME: "表达式",
  BLOCKS_PAGE_ID_DISPLAY_NAME: "页面 ID",
  BLOCKS_SYNCED_FROM_DISPLAY_NAME: "同步来源",
  BLOCKS_BLOCK_ID_DISPLAY_NAME: "区块 ID",
  BLOCKS_WIDTH_RATIO_DISPLAY_NAME: "宽度比例",
  BLOCKS_TABLE_WIDTH_DISPLAY_NAME: "表格宽度",
  BLOCKS_HAS_COLUMN_HEADER_DISPLAY_NAME: "有列标题",
  BLOCKS_HAS_ROW_HEADER_DISPLAY_NAME: "有行标题",
  BLOCKS_CELLS_DISPLAY_NAME: "单元格",
  BLOCKS_CONTENT_DISPLAY_NAME: "内容",
  BLOCKS_LINK_DISPLAY_NAME: "链接",
  BLOCKS_LANGUAGE_DISPLAY_NAME: "语言",
  BLOCKS_CAPTION_DISPLAY_NAME: "标题",
  ...
  PAGE_PROPERTIES_TYPE_DISPLAY_NAME: "类型",
  ...
  PAGE_PROPERTIES_START_DISPLAY_NAME: "开始",
  PAGE_PROPERTIES_END_DISPLAY_NAME: "结束",
  PAGE_PROPERTIES_TIME_ZONE_DISPLAY_NAME: "时区",
  PAGE_PROPERTIES_EXPIRY_TIME_DISPLAY_NAME: "过期时间",
  PAGE_PROPERTIES_LAT_DISPLAY_NAME: "纬度",
  PAGE_PROPERTIES_LON_DISPLAY_NAME: "经度",
  PAGE_PROPERTIES_ADDRESS_DISPLAY_NAME: "地址",
